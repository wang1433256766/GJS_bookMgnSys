...
<body>
	...
	<div class="wrap">
		...
		<p><center><span id="bookTip" style="color:red;font-size:18px;"></span></center></p>
		<div class="part-1">
			<div class="part1-left">
				...
				<p><div class="text-left">索书号：</div><div class="text-right"><input id="index" type="text" style="width:235px;">&nbsp;&nbsp;<button id="autoIndex" class="" style="padding:0 15px;">生成</button></div></p>
		...
		<div class="part-2">
			<div class="part2-left">
				...
				<p><div class="text-left">条形码：</div><div class="text-right"><input id="barcode" type="text" style="width:235px;"></div></p>
		...
		<div class="row-button">
			<button id="submitBtn">完成审核</button>
		</div>
	</div>
	<div class="footer">
...
<script src="../../public/js/bookAudit.js"></script>
</body>
</html>