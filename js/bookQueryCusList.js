    			...
    			for(var i in res.data.bookList){
    				...
    				content += '<li>'+
	    				'<div class="content-left">'+
		    				'<p>'+
			    				'<span><a href="/bookQueryCus/bookQueryCusListDetail?bid='+res.data.bookList[i].bid+'">'+nameStr+'</a></span><br>'+
			    				'<span><a href="/bookQueryCus/bookQueryCusListDetail?bid='+res.data.bookList[i].bid+'">'+nameStrf+'</a></span><br>'+
    		...
    		if(res.status == 0){
    			...
    			for(var i in res.data.bookList){
					...
					content += '<li>'+
				    				'<div class="content-left">'+
					    				'<p>'+
						    				'<span><a href="/bookQueryCus/bookQueryCusListDetail?bid='+res.data.bookList[i].bid+'">'+newstr+'</a></span><br>'+
						    				'<span><a href="/bookQueryCus/bookQueryCusListDetail?bid='+res.data.bookList[i].bid+'">'+newstrf+'</a></span><br>'+
