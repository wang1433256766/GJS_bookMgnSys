$(function(){	    
    ...
    //console.log(urlName);
    if(urlName.indexOf('bookQuery')>0){
        $("#nav-bookQuery").addClass("active");
    }else if(urlName.indexOf('bookBorrowed')>0){
        $("#nav-bookBorrowed").addClass("active");
    }else if(urlName.indexOf('bookMgn')>0){
        $("#nav-bookMgn").addClass("active");
    }else if(urlName.indexOf('recommendation')>0){
        $("#nav-recommendation").addClass("active");
    }else if(urlName.indexOf('userMgn')>0){
        $("#nav-userMgn").addClass("active");
    }else if(urlName.indexOf('sysConfig')>0){
        $("#nav-sysConfig").addClass("active");
